		...
		<div class="row">
			<div class="span12">
				<form action="<%=request.getContextPath()%>/deploy/hadoop/submit"
					...
					<input type="submit" class="btn btn-primary pull-right" style="margin-right: 10px" value="确定" />
					<input type="text" class="pull-right" style="margin-right: 10px" placeholder="集群名称" name="clusterName"/>
				</form>
			</div>
		</div>
	</div>
