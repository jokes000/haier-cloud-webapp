...
<div class="row">
	<div class="span12">
		<h3 class="text-left">
			现有虚拟机
			<a href="<%=request.getContextPath()%>/vm/add" class="btn btn-primary pull-right"><i
				class="icon-white icon-plus"></i>&nbsp;申请虚拟机</a>
			<button class="btn btn-primary pull-right" style="margin-right:10px" disabled="disabled">空闲虚拟机</button>
		</h3>
		<hr>
